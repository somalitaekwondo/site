...
if($toprocess=="addnewsletter"){
$_SESSION['IDPROCESSING'] = "NEWSLETTER";
$_SESSION['newslettermail'] = $_POST['email'];
$_SESSION['newslettername'] = $_POST['name'];
header('Location: processing');
};

if($_GET['PayPal_Ok']=="redirect"){
if($_SESSION['PayPal_Donation']=="5") header('Location: donated5'); 
if($_SESSION['PayPal_Donation']=="10") header('Location: donated10');
if($_SESSION['PayPal_Donation']=="25") header('Location: donated25');
if($_SESSION['PayPal_Donation']=="100") header('Location: donated100');
if($_SESSION['PayPal_Donation']=="500") header('Location: donated500');
};
